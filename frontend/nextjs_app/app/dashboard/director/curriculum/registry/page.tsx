...
export default function CompetencyRegistryPage() {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {frameworks.map(framework => (
              <Card key={framework.id} className="border-och-steel/30">
                <div className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {roles.map(role => (
                  <div
                    ...
                    className="p-4 bg-och-midnight/50 rounded-lg border border-och-steel/20 hover:border-och-mint/50 transition-colors"
                  >
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex gap-2">
                          <Link href={`/dashboard/director/curriculum/missions/${item.missionId}`}>
                      ...
                      <div className="mt-2">
                        <Link
                          href={`/dashboard/director/curriculum/missions/${item.missionId}`}
                    ...
                    return (
                      ...
                      >
                        ...
                        {hasMappings ? (
                          ...
                          <div className="mt-3 pt-3 border-t border-och-steel/20">
                            <p className="text-xs text-och-steel">
                              No framework mappings defined. Edit mission to add framework mappings.
                            </p>
                          </div>
                        )}
                      </div>
