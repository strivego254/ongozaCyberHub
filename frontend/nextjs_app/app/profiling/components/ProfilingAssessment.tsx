...
export default function ProfilingAssessment({
  ...
  }, [sessionToken, currentIndex, questions, responses])

  // Update progress when question changes
  useEffect(() => {
    djangoClient.profiler.updateProgress(sessionToken, section, currentIndex).catch(console.error)
  }, [sessionToken, section, currentIndex])
