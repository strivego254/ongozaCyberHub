...
Creates 50 users: 40 students, 5 mentors, 3 directors, 2 admins
...
class Command(BaseCommand):
    help = 'Create 50 bulk test users (40 students, 5 mentors, 3 directors, 2 admins) for development'
    ...
    def handle(self, *args, **options):
        ...
        # Create or get roles
        roles = {}
        role_names = ['admin', 'program_director', 'mentor', 'student']
