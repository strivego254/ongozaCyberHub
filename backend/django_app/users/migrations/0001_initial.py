# Generated by Django 4.2.26 on 2025-11-24 08:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('admin', 'Admin'), ('program_director', 'Program Director'), ('mentor', 'Mentor'), ('student', 'Student'), ('finance', 'Finance'), ('sponsor_admin', 'Sponsor/Employer Admin'), ('analyst', 'Analyst')], max_length=50, unique=True)),
        ...
        migrations.AlterUniqueTogether(
            name='userrole',
            unique_together={('user', 'role', 'scope', 'scope_ref'), ('user', 'role', 'cohort_id', 'track_key', 'org_id')},
        ),
        migrations.AddIndex(
